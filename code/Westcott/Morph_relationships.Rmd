...
# D survival
D_growth <- read_xlsx("data/sizes/D_2023POGS_small_seed_weekly/D_sizes_05132025.xlsx", guess_max = 2000)
...
means_vols <- growth %>%
  ...
  summarise(mean_vol = mean(predicted),
            std_error = sd(predicted)/sqrt(length(predicted)),
            .groups = 'drop')
