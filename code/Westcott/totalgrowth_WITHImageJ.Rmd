...
model.w<-glmmTMB(perc_change_vol ~  conditioning *days+ (1|bag_tag_num),data = vols_w, family = tweedie()) #glmmTMB
summary(model.w)
...
model.d<-glmmTMB(perc_change_vol ~  conditioning *days+ (1|bag_tag_num),data = vols_d, family = tweedie()) #glmmTMB
summary(model.d)
