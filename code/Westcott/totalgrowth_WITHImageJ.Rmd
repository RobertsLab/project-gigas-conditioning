...
B_length_graph <- means_sizes %>%
  ...
  theme_classic()+
    theme(
      axis.title.x = element_blank(),       
    axis.text.x = element_blank(),  # angled for readability
...
grid.arrange(B_length_graph, D_length_graph, B_vol_graph,D_vol_graph, ncol = 2, nrow = 2)
