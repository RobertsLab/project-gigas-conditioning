...
```{r}
# B survival
B_survival <- read_excel("/Users/graceleuchtenberger/Library/Mobile Documents/com~apple~CloudDocs/Documents/project-gigas-conditioning-GL/data/survival/Westcott/B_survival_07172024.xlsx")


# D survival
D_survival <- read_excel("/Users/graceleuchtenberger/Library/Mobile Documents/com~apple~CloudDocs/Documents/project-gigas-conditioning-GL/data/survival/Westcott/D_survival_07172024.xlsx")
...
means_live$effort <- c("B","B","B","B","B","B","B","B","D","D","D","D","D","D","D","D")
means_live$conditioning <- c("d_control","d_control","d_control","d_control", "daily","daily","daily","daily","w_control","w_control","w_control","w_control","weekly","weekly","weekly","weekly")
...
means_cumdead$effort <- c("B","B","B","B","B","B","B","B","D","D","D","D","D","D","D","D")
means_cumdead$conditioning <- c("d_control","d_control","d_control","d_control", "daily","daily","daily","daily","w_control","w_control","w_control","w_control","weekly","weekly","weekly","weekly")
```
...
means_prop$effort <- c("B","B","B","B","B","B","B","B","D","D","D","D","D","D","D","D")
means_prop$conditioning <- c("d_control","d_control","d_control","d_control", "daily","daily","daily","daily","w_control","w_control","w_control","w_control","weekly","weekly","weekly","weekly")
```
