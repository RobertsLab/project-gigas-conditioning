...
Obtain training data with known length width and depth from 20240909, 20250825, 20251008, and 20250522 datasets. 
```{r}
training_data<-data%>%
  filter(date %in% c("20240909", "20250825", "20251008", "20250522"))%>%
  filter(!is.na(volume))
