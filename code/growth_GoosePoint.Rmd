...
Obtain training data with known length width and depth from 20240909, 20250825, and 20251008 datasets. 
```{r}
training_data<-data%>%
  filter(date %in% c("20240909", "20250825", "20251008"))%>%
  filter(!is.na(volume))
...
```{r}
# Plot polynomial fit for Length vs. Volume
ggplot(data%>%filter(date %in% c("20240909", "20250825", "20251008")), aes(x = volume, y = Predicted_Volume_Poly)) +
  geom_point() +
