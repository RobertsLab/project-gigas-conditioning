...
Obtain training data with known length width and depth from 20240909 and 20250825 dataset. 
```{r}
training_data<-data%>%
  filter(date %in% c("20240909", "20250825"))%>%
  filter(!is.na(volume))
...
```{r}
# Plot polynomial fit for Length vs. Volume
ggplot(data%>%filter(date %in% c("20240909", "20250825")), aes(x = volume, y = Predicted_Volume_Poly)) +
  geom_point() +
...
Calculate percent change manually. 

```{r}
((53929.24-43262.29)/43262.29)
```
